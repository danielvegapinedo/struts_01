...
public class EmailTypesClassicController extends ActionSupport {
    ...
    public String createEmailTypesStart() {
    ...
    public String updateEmailTypesStart() {

       this.et = this.ed.findType(this.et.getEmailType());
